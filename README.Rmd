...
Last month the [R/Pharma](https://www.rinpharma.com) conference took place at the Harvard Campus in Cambridge,MA. I presented our development project called bioWARP, which is a large [shiny](https://shiny.rstudio.com/) application of containing more than 500.000 lines of code. And I noticed, actually nobody else ever came to the idea to write such a [shiny](https://shiny.rstudio.com/) application. And I asked myself, why?
